<template>
    <div>
      <h1>유저끼리 대화</h1>
      <div class="col-12 chat_contaner">
      ...
      <form @submit.prevent="enterUsername">
        <input v-model="usernameInput" type="text" id="username-input" autocomplete="off" />
        <input v-model="messageInput" type="text" id="message-input" autocomplete="off" />
